...
namespace ObbedNews.Controllers.Comments
{
    ...
    public class CommentsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Comment>>> GetCommentsWaitModeration()
        {
            var comments = await _context.Comments
                .OrderByDescending(c => c.Id)
                .Include(c => c.User.Account)
        ...
        public async Task<ActionResult<Comment>> UpdateCommentStatus(
